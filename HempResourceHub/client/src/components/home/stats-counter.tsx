...
const StatsCounter = () => {
  ...
  return (
    <div className="bg-primary py-12" data-oid="yihtweo">
      <div
      ...
      >
        ...
        <div className="max-w-3xl mx-auto" data-oid="qpciq8w">
          <form onSubmit={handleSearch} className="relative" data-oid="20dbv0g">
            <Input
              type="text"
          ...
          <div className="mt-10 text-white" data-oid="s1zoz2.">
            <p
            ...
            >
              {isLoading ? (
                <span className="opacity-50" data-oid="o:ypdwo">
                  Loading...
                </span>
              ) : (
                <Counter
